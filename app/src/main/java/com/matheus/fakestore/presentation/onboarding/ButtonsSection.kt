...
import com.matheus.fakestore.ui.theme.GreenApp
import com.matheus.fakestore.ui.theme.GreenAppDark
        ...
        Column(
            ...
            Column(
                ...
                Button(
                    ...
                    Text(
                        text = stringResource(R.string.cart).uppercase(Locale.getDefault()),
...
//
//                    Text(
//                        text = stringResource(R.string.home).uppercase(Locale.getDefault()),
//                        style = MaterialTheme.typography.titleMedium,
